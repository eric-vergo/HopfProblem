...
# one script so the workstation packaging step (scripts/package_site.sh) and the
# Pages deploy workflow (.github/workflows/site-deploy.yml) refuse the same trees.
#
...
#
# Usage: scripts/site_offline_gates.sh <html-multi directory>
set -euo pipefail
