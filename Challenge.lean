...
This file has been modified from the original Formal Conjectures source.
The project-specific import and conjecture metadata were removed, and the
theorem statement was aligned with Solution.lean.
